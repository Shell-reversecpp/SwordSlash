       ...
       public virtual bool LeftClick()
{
    ...
    return false;
        ...
        public virtual bool LeftClickHold()
        {
            ...
            if( newMouse.LeftButton == Microsoft.Xna.Framework.Input.ButtonState.Pressed && oldMouse.LeftButton == Microsoft.Xna.Framework.Input.ButtonState.Pressed && newMouse.Position.X >= 0 && newMouse.Position.X <= screenWidth && newMouse.Position.Y >= 0 && newMouse.Position.Y <= screenHeight)
            {
                holding = true;
        ...
        {
            if(newMouse.RightButton == Microsoft.Xna.Framework.Input.ButtonState.Pressed && oldMouse.RightButton != Microsoft.Xna.Framework.Input.ButtonState.Pressed && newMouse.Position.X >= 0 && newMouse.Position.X <= screenWidth && newMouse.Position.Y >= 0 && newMouse.Position.Y <= screenHeight)
            {
                return true;
            }
